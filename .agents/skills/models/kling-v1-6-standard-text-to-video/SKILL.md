...
description: "Kling v1.6 | Standard | Text to Video. Generate videos from text descriptions using Kling v1.6 | Standard | Text to Video. Triggers: kling, text to video, video generation"
allowed-tools: Bash(curl *), WebFetch
---

# Kling v1.6 | Standard | Text to Video

Generate videos from text descriptions using Kling v1.6 | Standard | Text to Video. Supports multiple aspect ratios (16:9, 9:16, 1:1), configurable duration, negative prompt support, adjustable CFG scale.
