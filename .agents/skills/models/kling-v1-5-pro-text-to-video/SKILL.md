...
description: "Kling v1.5 | Pro | Text-to-Video. Generate videos from text descriptions using Kling v1.5 | Pro | Text-to-Video. Triggers: kling, text to video, video generation"
allowed-tools: Bash(curl *), WebFetch
---

# Kling v1.5 | Pro | Text-to-Video

Generate videos from text descriptions using Kling v1.5 | Pro | Text-to-Video. Supports multiple aspect ratios (16:9, 9:16, 1:1), configurable duration, negative prompt support, adjustable CFG scale.
...
curl -X POST https://api.eachlabs.ai/v1/prediction \
  ...
  -d '{
    "model": "kling-v1-5-pro-text-to-video",
    "version": "0.0.1",
    "input": {
