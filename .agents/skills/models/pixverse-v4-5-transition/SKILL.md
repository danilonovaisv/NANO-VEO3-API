...
description: "PixVerse v4.5 | Transition. Create smooth video transitions between images using PixVerse v4.5 | Transition. Triggers: pixverse, video generation, video transition"
allowed-tools: Bash(curl *), WebFetch
---

# PixVerse v4.5 | Transition

Create smooth video transitions between images using PixVerse v4.5 | Transition. Supports configurable duration, reproducible results via seed, quality control.
...
curl -X POST https://api.eachlabs.ai/v1/prediction \
  ...
  -d '{
    "model": "pixverse-v4-5-transition",
    "version": "0.0.1",
    "input": {
