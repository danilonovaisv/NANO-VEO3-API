...
description: "Kling v1.6 | Pro | Elements. Generate creative element-based videos using Kling v1.6 | Pro | Elements. Triggers: kling, video effects, video generation"
allowed-tools: Bash(curl *), WebFetch
---

# Kling v1.6 | Pro | Elements

Generate creative element-based videos using Kling v1.6 | Pro | Elements. Supports multiple aspect ratios (16:9, 9:16, 1:1), configurable duration, negative prompt support.
