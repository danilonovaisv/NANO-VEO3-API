---
name: kling-v1-6-pro-image-to-video
description: "Kling v1.6 | Pro | Image to Video. Generate videos from images using Kling v1.6 | Pro | Image to Video. Triggers: image to video, kling, video generation"
allowed-tools: Bash(curl *), WebFetch
---

# Kling v1.6 | Pro | Image to Video

Generate videos from images using Kling v1.6 | Pro | Image to Video. Supports multiple aspect ratios (16:9, 9:16, 1:1), configurable duration, negative prompt support, adjustable CFG scale.
...
curl -X POST https://api.eachlabs.ai/v1/prediction \
  ...
  -d '{
    "model": "kling-v1-6-pro-image-to-video",
    "version": "0.0.1",
    "input": {
