...
description: "Kling v2 | Image to Video. Generate videos from images using Kling v2 | Image to Video. Triggers: image to video, kling, video generation"
allowed-tools: Bash(curl *), WebFetch
---

# Kling v2 | Image to Video

Generate videos from images using Kling v2 | Image to Video. Supports multiple aspect ratios (16:9, 9:16, 1:1), configurable duration, negative prompt support, adjustable CFG scale.
