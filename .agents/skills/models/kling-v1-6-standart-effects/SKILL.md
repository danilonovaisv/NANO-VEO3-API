---
name: kling-v1-6-standart-effects
description: "Kling v1.6 | Standard | Effects. Apply visual effects to images and generate videos using Kling v1.6 | Standard | Effects. Triggers: kling, video effects, video generation"
allowed-tools: Bash(curl *), WebFetch
---

# Kling v1.6 | Standard | Effects

Apply visual effects to images and generate videos using Kling v1.6 | Standard | Effects. Supports configurable duration.
...
curl -X POST https://api.eachlabs.ai/v1/prediction \
  ...
  -d '{
    "model": "kling-v1-6-standart-effects",
    "version": "0.0.1",
    "input": {
...
| `template_slug` | string | hug | Options: `hug`, `kiss`, `heart_gesture`, `squish`, `expansion`, `fuzzyfuzzy`, `bloombloom`, `dizzydizzy` |
