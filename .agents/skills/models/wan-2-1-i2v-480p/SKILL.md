...
description: "Wan 2.1 | Image to Video | 480P. Generate videos from images using Wan 2.1 | Image to Video | 480P. Triggers: image to video, video generation, wan"
allowed-tools: Bash(curl *), WebFetch
---

# Wan 2.1 | Image to Video | 480P

Generate videos from images using Wan 2.1 | Image to Video | 480P. Supports reproducible results via seed.
...
|-----------|------|---------|-------------|
| `fast_mode` | string | Off | An enumeration.. Options: `Off`, `Balanced`, `Fast` |
...
| `max_area` | string | 832x480 | An enumeration.. Options: `832x480`, `480x832` |
...
| `sample_shift` | number | 3 | Sample shift factor |
...
- [Wan 2.1 | Image to Video | 720P](../wan-2-1-i2v-720p/) - Generate videos from images using Wan 2.1 | Image to Video | 720P.
