---
name: imagen-3
description: "Imagen 3. Generate image content using Imagen 3. Triggers: image generation, imagen"
allowed-tools: Bash(curl *), WebFetch
---

# Imagen 3

Generate image content using Imagen 3. Supports multiple aspect ratios (1:1, 9:16, 16:9, 3:4, 4:3), negative prompt support.
...
- [Imagen 3 | Fast](../imagen-3-fast/) - Generate image content using Imagen 3 | Fast.
