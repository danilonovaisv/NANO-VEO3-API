...
description: "PixVerse v4 | Text to Video. Generate videos from text descriptions using PixVerse v4 | Text to Video. Triggers: pixverse, text to video, video generation"
allowed-tools: Bash(curl *), WebFetch
---

# PixVerse v4 | Text to Video

Generate videos from text descriptions using PixVerse v4 | Text to Video. Supports multiple aspect ratios (16:9, 4:3, 1:1, 3:4, 9:16), configurable duration, negative prompt support, reproducible results via seed, style selection, quality control.
