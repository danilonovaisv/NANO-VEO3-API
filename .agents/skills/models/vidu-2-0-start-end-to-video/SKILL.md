...
description: "Vidu 2.0 | Start End to Video. Generate videos from start and end frame images using Vidu 2.0 | Start End to Video. Triggers: start end to video, video generation, vidu"
...
| `end_image_url` | string |  | End Image |
...
| `resolution` | string | 720p | Options: `1080p`, `720p` |
| `seed` | integer |  |  |
